    ...
    <Fragment>
      <section className='flex justify-around gap-2 pt-10'>
        <main className='w-2/4 px-10 flex flex-col gap-5'>
          <h1 className='text-ra text-4xl font-bold text-center'>REGISTER AN ACCOUNT</h1>
          ...
          <div className='flex gap-5'>
            ...
            <Button className='flex justify-center items-center gap-2 w-2/4 text-ra' onPress={handleRegister} color='secondary'>Register<i className='fi fi-rr-arrow-right flex justify-center items-center'></i></Button>
          </div>
        </main>
        <div className='w-2/4 flex justify-center items-center px-10'>
          <Image src={'/image-register.svg'} alt={'Image Register'} width={500} height={500} />-
        </div>
      </section>
    </Fragment>
  );
